...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='ramen')
        tag1 = sample_tag(user=self.user, name='tag1')
        tag2 = sample_tag(user=self.user, name='tag2')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='curry111')
        recipe2 = sample_recipe(user=self.user, title='ramen222')
        ingredient1 = sample_ingredient(user=self.user, name='ingredient1111')
        ingredient2 = sample_ingredient(user=self.user, name='ingredient2222')
